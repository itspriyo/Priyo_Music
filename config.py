...
class Config:
    ...
    #Stream 
    STREAM_URL=os.environ.get("STARTUP_STREAM", "https://www.youtube.com/watch?v=sAF8FGJ5tWI")
   
    #Database
    DATABASE_URI=os.environ.get("DATABASE_URI", None)
    DATABASE_NAME=os.environ.get("DATABASE_NAME", "PremiumMusicBot")
...
⚠️ If you start a recording with player, make sure you stop the same with player.
...
__Example: To set up a__ `REPLY_MESSAGE` __use__ `/env REPLY_MESSAGE=Hey, Check out @PremiumNetworkCommunity rather than spamming in my PM`__

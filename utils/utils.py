...
async def set_up_startup():
    ...
    if match:
        ...
        try:
            ...
            Config.STREAM_URL="https://filmymirchihdliv-lh.akamaihd.net/i/FilmyMirchiHDLive_1_1@336266/master.m3u8"
            LOGGER.error("Unable to fetch youtube playlist, starting Radio")
            pass
...
async def c_play(channel):
    ...
    try:
        ...
        if who == 0:
            ...
            if Config.CPLAY:
                Config.CPLAY=False
                Config.STREAM_URL="https://www.youtube.com/watch?v=sAF8FGJ5tWI"
